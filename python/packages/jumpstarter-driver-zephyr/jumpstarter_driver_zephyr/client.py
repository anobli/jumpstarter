...
class ZephyrClient(DriverClient):
    ...
    def _twister_argv(self, platform: str, tty: str, test_roots: list[str]) -> list[str]:
    ...
    def twister(self, platform: str, twister_out: str, test_roots: list[str]) -> None:
        ...
        argv = self._twister_argv(platform, tty, test_roots)
    ...
    def cli(self):
        ...
        def twister(platform, twister_out, test_roots):
            """Run twister to test Zephyr firmware on the exporter."""
            self.logger.info("Running twister...")
            self.twister(platform, twister_out, test_roots)
